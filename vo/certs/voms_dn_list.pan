...
variable VOMS_SERVER_DN ?= list(
    ...
    'ngi-il-voms3.isragrid.org.il', nlist('subject', '/DC=org/DC=terena/DC=tcs/OU=Domain Control Validated/CN=ngi-il-ui3.isragrid.org.il',
    ...
    'voms.ciemat.es',               nlist('subject', '/DC=es/DC=irisgrid/O=ciemat/CN=voms.ciemat.es',
                                          'issuer', '/DC=es/DC=irisgrid/CN=IRISGridCA',
                                         ),

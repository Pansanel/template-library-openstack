...
'/software/components/mysql/databases/' = {
    SELF[OS_CINDER_DB_NAME]['createDb'] = true;
    SELF[OS_CINDER_DB_NAME]['server'] = CINDER_MYSQL_SERVER;
    SELF[OS_CINDER_DB_NAME]['users'][OS_CINDER_DB_USERNAME] = nlist(
...
variable CINDER_ENDPOINTS_CONTENTS = replace('CINDER_PASSWORD',OS_CINDER_PASSWORD,CINDER_ENDPOINTS_CONTENTS);
variable CINDER_ENDPOINTS_CONTENTS = replace('CINDER_EMAIL',CINDER_EMAIL,CINDER_ENDPOINTS_CONTENTS);
variable CINDER_ENDPOINTS_CONTENTS = replace('CINDER_CONTROLLER_HOST',OS_CINDER_CONTROLLER_HOST,CINDER_ENDPOINTS_CONTENTS);
variable CINDER_ENDPOINTS_CONTENTS = replace('CINDER_MGMT_HOST',OS_CINDER_MGMT_HOST,CINDER_ENDPOINTS_CONTENTS);
